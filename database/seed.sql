...
-- -------------------------------------------------
-- Bersihkan data lama supaya insert ulang tidak bentrok
-- (Duplicate entry error terjadi karena data lama masih ada)
-- -------------------------------------------------
SET FOREIGN_KEY_CHECKS = 0;
TRUNCATE TABLE bacaan;
TRUNCATE TABLE gerakan;
...
('REZA RAMADHAN, SURYA HAFAZH, MOCH YANWAR Q,TRISYA SUPRIATI C, PUTRI CANTIKA CITRA SH ', 'Teknik Informatika', 'AIK 4', 'Dedy Susanto, S.Pd.I., M.M.');
...
-- =========================================================
-- KATEGORI DEWASA (id_kategori = 1, Dipaksa ID 1 - 13)
-- =========================================================
INSERT INTO gerakan (id, id_kategori, nama, urutan, deskripsi, gambar_url, video_url) VALUES
(1, 1,'Niat dan Berdiri Menghadap Kiblat (Qiyam)',1,
 ...
 'assets/img/dewasa/01-qiyammmm.jpg','assets/video/01-qiyam.mp4'),

(2, 1,'Takbiratul Ihram',2,
 ...
 'assets/img/dewasa/02-takbiratul-ihram.jpg','assets/video/02-takbiratul-ihram.mp4'),

(3, 1,'Bersedekap — Membaca Doa Iftitah',3,
 ...
 'assets/img/dewasa/03-bersedekap.jpg','assets/video/03-bersedekap.mp4'),

(4, 1,'Membaca Al-Fatihah dan Surah',4,
 ...
 'assets/img/dewasa/04-membaca-surah.jpg','assets/video/04-membaca-surah.mp4'),
...
(5, 1,'Rukuk',5,
 ...
 'assets/img/dewasa/05-rukuk.jpg','assets/video/05-rukuk.mp4'),

(6, 1,'I\'tidal (Bangkit dari Rukuk)',6,
 ...
 'assets/img/dewasa/06-itidal.jpg','assets/video/06-itidal.mp4'),
...
(7, 1,'Sujud Pertama',7,
 ...
 'assets/img/dewasa/07-sujud-1.jpg','assets/video/07-sujud-1.mp4'),

(8, 1,'Duduk di Antara Dua Sujud (Iftirasy)',8,
 'Bangun dari sujud, duduklah dengan posisi Iftirasy yaitu duduk di atas telapak kaki kiri, kaki kanan ditegakkan.',
 'assets/img/dewasa/08-duduk-iftirasy.jpg','assets/video/08-duduk-iftirasy.mp4'),
...
(9, 1,'Sujud Kedua',9,
 ...
 'assets/img/dewasa/09-sujud-2.jpg','assets/video/09-sujud-2.mp4'),

(10, 1,'Berdiri ke Rakaat Berikutnya',10,
 'Bangun dari sujud kedua untuk menuju rakaat berikutnya. Berdiri tegak menghadap kiblat.',
 'assets/img/dewasa/10-berdiri-rakaat.jpg','assets/video/10-berdiri-rakaat.mp4'),

(11, 1,'Duduk Tasyahud Awal (Iftirasy)',11,
 ...
 'assets/img/dewasa/11-tasyahud-awal.jpg','assets/video/11-tasyahud-awal.mp4'),

(12, 1,'Duduk Tasyahud Akhir (Tawarruk)',12,
 ...
 'assets/img/dewasa/12-tasyahud-akhir.jpg','assets/video/12-tasyahud-akhir.mp4'),
...
(13, 1,'Salam',13,
 ...
 'assets/img/dewasa/13-salam.jpg','assets/video/13-salam.mp4');


-- =========================================================
-- KATEGORI ANAK-ANAK (id_kategori = 2, Dipaksa ID 14 - 26)
-- =========================================================
INSERT INTO gerakan (id, id_kategori, nama, urutan, deskripsi, gambar_url, video_url) VALUES
(14, 2,'Berdiri Menghadap Kiblat',1,
 'Berdiri tegak sambil niat dalam hati mau sholat. Niat tidak perlu diucapkan, cukup diingat dalam hati ya, adik-adik!',
 'assets/img/anak/01-qiyam.jpg','assets/video/01-qiyam.mp4'),

(15, 2,'Takbiratul Ihram',2,
 'Angkat kedua tangan setinggi bahu sambil bilang Allahu Akbar. Artinya: Allah Maha Besar! Lalu lipat tangan di dada.',
 'assets/img/anak/02-takbiratul-ihram.jpg','assets/video/02-takbiratul-ihram.mp4'),

(16, 2,'Bersedekap — Doa Iftitah',3,
 'Tangan kanan di atas tangan kiri di dada, lalu baca doa iftitah dengan pelan dan khusyuk.',
 'assets/img/anak/03-bersedekap.jpg','assets/video/03-bersedekap.mp4'),

(17, 2,'Membaca Al-Fatihah',4,
 'Baca surat Al-Fatihah dengan pelan dan penuh rasa syukur. Setelah selesai ucapkan Aamiin!',
 'assets/img/anak/04-membaca-surah.jpg','assets/video/04-membaca-surah.mp4'),

(18, 2,'Rukuk',5,
 'Membungkuk dengan punggung lurus seperti meja. Tangan memegang lutut. Punggung harus rata ya!',
 'assets/img/anak/05-rukuk.jpg','assets/video/05-rukuk.mp4'),

(19, 2,'I\'tidal — Bangun dari Rukuk',6,
 'Berdiri tegak lagi. Setelah berdiri, tangan dilepaskan lurus ke bawah, tidak dilipat lagi.',
 'assets/img/anak/06-itidal.jpg','assets/video/06-itidal.mp4'),

(20, 2,'Sujud Pertama',7,
 ...
 'assets/img/anak/07-sujud-1.jpg','assets/video/07-sujud-1.mp4'),

(21, 2,'Duduk di Antara Dua Sujud',8,
 'Duduk sebentar di antara dua sujud sambil berdoa minta ampun dan rezeki kepada Allah.',
 'assets/img/anak/08-duduk-iftirasy.jpg','assets/video/08-duduk-iftirasy.mp4'),

(22, 2,'Sujud Kedua',9,
 'Sujud lagi seperti sujud pertama. Tujuh anggota badan menyentuh lantai.',
 'assets/img/anak/09-sujud-2.jpg','assets/video/09-sujud-2.mp4'),

(23, 2,'Berdiri ke Rakaat Berikutnya',10,
 'Bangun lagi untuk rakaat selanjutnya. Ayo semangat!',
 'assets/img/anak/10-berdiri-rakaat.jpg','assets/video/10-berdiri-rakaat.mp4'),

(24, 2,'Duduk Tasyahud Awal',11,
 'Duduk sambil membaca bacaan tasyahud. Jari telunjuk kanan diacungkan ke depan.',
 'assets/img/anak/11-tasyahud-awal.jpg','assets/video/11-tasyahud-awal.mp4'),

(25, 2,'Duduk Tasyahud Akhir',12,
 'Duduk di rakaat terakhir. Baca tasyahud dan shalawat untuk Nabi Muhammad ﷺ.',
 'assets/img/anak/12-tasyahud-akhir.jpg','assets/video/12-tasyahud-akhir.mp4'),

(26, 2,'Salam — Sholat Selesai! 🎉',13,
 'Menoleh ke kanan lalu ke kiri sambil mengucap salam. Sholat sudah selesai, alhamdulillah!',
 'assets/img/anak/13-salam.jpg','assets/video/13-salam.mp4');
...
-- Gerakan 3: Doa Iftitah (Allahumma Baid)
INSERT INTO bacaan (id_gerakan, urutan, teks_arab, teks_latin, terjemahan, audio_url, sumber) VALUES
(3,1,
...
(6,1,
 ...
 'assets/audio/dewasa/06-itidal.mp3',
 'HPT Muhammadiyah - Kitab Shalat');
...
-- Gerakan 15: Takbir (Anak)
INSERT INTO bacaan (id_gerakan, urutan, teks_arab, teks_latin, terjemahan, audio_url, sumber) VALUES
(15,1,'اللهُ أَكْبَرُ','Allaahu Akbar','Allah Maha Besar.','assets/audio/anak/02-takbir-anak.mp3','HPT Muhammadiyah');

-- Gerakan 16: Iftitah (Anak)
INSERT INTO bacaan (id_gerakan, urutan, teks_arab, teks_latin, terjemahan, audio_url, sumber) VALUES
(16,1,
 ...
 'assets/audio/anak/03-iftitah-anak.mp3','HPT Muhammadiyah');

-- Gerakan 17: Al-Fatihah (Anak)
INSERT INTO bacaan (id_gerakan, urutan, teks_arab, teks_latin, terjemahan, audio_url, sumber) VALUES
(17,1,
 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ ۝ الْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ ۝ الرَّحْمَٰنِ الرَّحِيمِ ۝ مَالِكِ يَوْمِ الدِّينِ ۝ إِيَّاكَ نَعْبُدُ وَإِيَّاكَ نَسْتَعِينُ ۝ اهْدِنَا الصِّرَاطَ الْمُسْتَقِيمَ ۝ صِرَاطَ الَّذِينَ أَنْعَمْتَ عَلَيْهِمْ غَيْرِ الْمَغْضُوبِ عَلَيْهِمْ وَلَا الضَّالِّينَ',
 'Bismillaahirrahmaanirrahiim. Alhamdu lillaahi rabbil ''aalamiin. Arrahmaanirrahiim. Maaliki yaumid diin. Iyyaaka na''budu wa iyyaaka nasta''iin. Ihdinash shiraathal mustaqiim. Shiraathal ladziina an''amta ''alaihim ghairil maghduubi ''alaihim waladh dhaaalliin.',
 'Dengan nama Allah Yang Maha Pengasih, Maha Penyayang. Segala puji bagi Allah, Tuhan seluruh alam, Yang Maha Pengasih, Maha Penyayang, Pemilik hari pembalasan. Hanya kepada Engkaulah kami menyembah dan hanya kepada Engkaulah kami mohon pertolongan. Tunjukilah kami jalan yang lurus, yaitu jalan orang-orang yang telah Engkau beri nikmat kepadanya; bukan jalan mereka yang dimurkai, dan bukan pula jalan mereka yang sesat.',
 'assets/audio/anak/04-alfatihah-anak.mp3',
 'Al-Quran Surat Al-Fatihah 1-7');

-- Gerakan 18: Rukuk (Anak)
INSERT INTO bacaan (id_gerakan, urutan, teks_arab, teks_latin, terjemahan, audio_url, sumber) VALUES
(18,1,
 'سُبْحَانَكَ اللَّهُمَّ رَبَّنَا وَبِحَمْدِكَ ، اللَّهُمَّ اغْفِرْ لِي',
 'Subhaanakallaahumma rabbanaa wa bihamdika allaahummaghfirlii.',
 'Maha Suci Allah Tuhanku, dan dengan memuji-Mu. Ya Allah, ampunilah aku.',
 'assets/audio/anak/05-rukuk-anak.mp3','HPT Muhammadiyah');

-- Gerakan 19: I'tidal (Anak)
INSERT INTO bacaan (id_gerakan, urutan, teks_arab, teks_latin, terjemahan, audio_url, sumber) VALUES
(19,1,
 'سَمِعَ اللهُ لِمَنْ حَمِدَهُ ، رَبَّنَا وَلَكَ الْحَمْدُ',
 'Sami''allaahu liman hamidah, Rabbanaa wa lakal hamd.',
 'Allah mendengar pujian orang yang memuji-Nya. Ya Tuhan kami, bagi-Mu segala puji.',
 'assets/audio/anak/06-itidal-anak.mp3','HPT Muhammadiyah');

-- Gerakan 20: Sujud Pertama (Anak)
INSERT INTO bacaan (id_gerakan, urutan, teks_arab, teks_latin, terjemahan, audio_url, sumber) VALUES
(20,1,
 'سُبْحَانَكَ اللَّهُمَّ رَبَّنَا وَبِحَمْدِكَ ، اللَّهُمَّ اغْفِرْ لِي',
 'Subhaanakallaahumma rabbanaa wa bihamdika allaahummaghfirlii.',
 'Maha Suci Allah Tuhanku, dan dengan memuji-Mu. Ya Allah, ampunilah aku.',
 'assets/audio/anak/07-sujud-anak.mp3','HPT Muhammadiyah');

-- Gerakan 21: Duduk di Antara Dua Sujud (Anak)
INSERT INTO bacaan (id_gerakan, urutan, teks_arab, teks_latin, terjemahan, audio_url, sumber) VALUES
(21,1,
 'اللَّهُمَّ اغْفِرْ لِي ، وَارْحَمْنِي ، وَاجْبُرْنِي ، وَاهْدِنِي ، وَارْزُقْنِي',
 'Allaahummaghfirlii warhamnii wajburnii wahdinii warzuqnii.',
 'Ya Allah ampunilah aku, sayangilah aku, cukupkanlah aku, berilah aku petunjuk, dan rezeki.',
 'assets/audio/anak/08-duduk-antara-sujud-anak.mp3','HPT Muhammadiyah');

-- Gerakan 22: Sujud Kedua (Anak)
INSERT INTO bacaan (id_gerakan, urutan, teks_arab, teks_latin, terjemahan, audio_url, sumber) VALUES
(22,1,
 'سُبْحَانَكَ اللَّهُمَّ رَبَّنَا وَبِحَمْدِكَ ، اللَّهُمَّ اغْفِرْ لِي',
 'Subhaanakallaahumma rabbanaa wa bihamdika allaahummaghfirlii.',
 'Maha Suci Allah Tuhanku, dan dengan memuji-Mu. Ya Allah, ampunilah aku.',
 'assets/audio/anak/09-sujud-2-anak.mp3','HPT Muhammadiyah');

-- Gerakan 24: Tasyahud Awal (Anak)
INSERT INTO bacaan (id_gerakan, urutan, teks_arab, teks_latin, terjemahan, audio_url, sumber) VALUES
(24,1,
 'التَّحِيَّاتُ لِلَّهِ وَالصَّلَوَاتُ وَالطَّيِّبَاتُ ...',
 'Attahiyyaatu lillaahi wash sholawaatu wath thayyibaat...',
 'Segala penghormatan hanya milik Allah... (bacaan tasyahud)',
 'assets/audio/anak/11-tasyahud-awal-anak.mp3','HPT Muhammadiyah');

-- Gerakan 25: Tasyahud Akhir (Anak)
INSERT INTO bacaan (id_gerakan, urutan, teks_arab, teks_latin, terjemahan, audio_url, sumber) VALUES
(25,1,
'التَّحِيَّاتُ لِلَّهِ وَالصَّلَوَاتُ وَالطَّيِّبَاتُ ... اللَّهُمَّ صَلِّ عَلَى مُحَمَّدٍ وَعَلَى آلِ مُحَمَّدٍ ، كَمَا صَلَّيْتَ عَلَى إِبْرَاهِيمَ وَعَلَى آلِ إِبْرَاهِيمَ ، إِنَّكَ حَمِيدٌ مَجِيدٌ ، اللَّهُمَّ بَارِكْ عَلَى مُحَمَّدٍ وَعَلَى آلِ مُحَمَّدٍ ، كَمَا بَارَكْتَ عَلَى إِبْرَاهِيمَ وَعَلَى آلِ إِبْرَاهِيمَ ، إِنَّكَ حَمِيدٌ مَجِيدٌ',
'Attahiyyaatu lillaahi wash sholawaatu wath thayyibaat..., Allaahumma shalli alaa muhammadin wa alaa aali muhammad. Kamaa shallaita alaa ibraahiima wa alaa aali ibraahiim. Allaahumma baarik alaa muhammadin wa alaa aali muhammad. Kamaa baarakta alaa ibraahiima wa alaa aali ibraahiim. Innaka hamiidun majiid.',
 'Segala penghormatan hanya milik Allah... (bacaan tasyahud), Ya Allah, limpahkanlah shalawat kepada Nabi Muhammad dan keluarga Nabi Muhammad sebagaimana Engkau telah melimpahkan shalawat kepada Nabi Ibrahim dan keluarga Nabi Ibrahim. Sesungguhnya Engkau Maha Terpuji lagi Maha Mulia. Ya Allah, limpahkanlah keberkahan kepada Nabi Muhammad dan keluarga Nabi Muhammad sebagaimana Engkau telah melimpahkan keberkahan kepada Nabi Ibrahim dan keluarga Nabi Ibrahim. Sesungguhnya Engkau Maha Terpuji lagi Maha Mulia.',
'assets/audio/anak/12-tasyahud-akhir-anak.mp3',
'HPT Muhammadiyah');

-- Gerakan 26: Salam (Anak)
INSERT INTO bacaan (id_gerakan, urutan, teks_arab, teks_latin, terjemahan, audio_url, sumber) VALUES
(26,1,
 'السَّلاَمُ عَلَيْكُمْ وَرَحْمَةُ اللهِ ',
 'Assalaamu ''alaikum wa rahmatullaahi.',
 'Semoga keselamatan, rahmat Allah.',
 'assets/audio/anak/13-salam-anak.mp3','HPT Muhammadiyah');
